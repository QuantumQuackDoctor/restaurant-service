...
public class RestaurantApiController implements RestaurantApi {
	...
	@Override
	public ResponseEntity<List<RestaurantEntity>> getFood(String search, String geolocation,
			String sortType, String sortValue, Integer stars, Integer price, Integer page, Integer size)
